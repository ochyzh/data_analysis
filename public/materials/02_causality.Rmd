...
mytable<-tapply(rosca2$bg_female, rosca2$treatment, mean)
...
.center[Age]
```{r, echo=F}
mytable<-tapply(rosca2$bg_b1_age, rosca2$treatment, mean)
knitr::kable(t(mytable))
```

.center[Marital Status]
```{r, echo=F}
mytable<-tapply(rosca2$bg_married, rosca2$treatment, mean)
knitr::kable(t(mytable))
```
...
mytable <-tapply(rosca2.married$fol2_amtinvest, rosca2.married$treatment, mean)
knitr::kable(t(mytable))
```
